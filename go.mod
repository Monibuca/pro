...
require (
	...
	// m7s.live/plugin/snappro/v4 v4.0.0-20230317011613-8b624abac58d
	m7s.live/plugin/transcode/v4 v4.0.0-20230911180024-a0f8341af55e
...
require (
	...
	github.com/dwdcth/ffmpeg-go v0.0.0-20230610054319-d17c99e0aa0c // indirect
